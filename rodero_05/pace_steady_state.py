...
Saves the steady-state states by name, a last-beat trace, and a diagnostic figure.
...
ap.add_argument("--odefile", default="../simcardemsx/numerical_experiments/odefiles/ToRORd_dynCl_endo_zetasplit.ode")
ap.add_argument("--outdir", default="steady_state_pcl800")
...
for ct, name in CELLTYPES.items():
    ...
    (outdir / f"celltype{ct}_{name}.json").write_text(json.dumps({
        ...
        "odefile": args.odefile, "biomarkers": bio,
